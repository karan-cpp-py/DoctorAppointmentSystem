  ...
  return (
    <div className='doctornavbar'>
      <div className='doctornavbar31'>
        ...
        <div className='doctornavbar312'><Link to="/">About</Link></div>
        <div className='doctornavbar312'><Link to="/">Events</Link></div>
        <div className='doctornavbar312'><Link to="/">Gallery</Link></div>
