...
const EditPatientDetails = () => {
    ...
    return (
        <div className='editpatientdetails'>
            <div className='editpatientimage'><img className='editpatientprofileimage' src={`http://localhost:8000/profileImages/` + patientDetails.profile_image} alt='patient'></img></div>
