  ...
  return (
    <div className='adminnavbar'>
      <div className='adminnavbar31'>
        ...
        <div className='adminnavbar312'><Link to="/">About</Link></div>
        <div className='adminnavbar312'><Link to="/">Events</Link></div>
        <div className='adminnavbar312'><Link to="/">Gallery</Link></div>
